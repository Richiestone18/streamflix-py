#!/usr/bin/env python3
"""
Streamflix Desktop App (web browser mode)
Launches the FastAPI server and opens it in the default web browser.
Works on any Windows/Linux/Mac without pywebview or WebView2 dependencies.
"""
import sys
import os
import threading
