"""
PlutoTV AR IPTV provider (Spanish live TV - Argentina).
Ported from streamflix-reborn/streamflix PlutoTvArProvider.
...
class PlutoTvArProvider(BaseProvider):
    name = "PlutoTV AR"
    base_url = "https://raw.githubusercontent.com"
    language = "es"

    _PLAYLIST = "https://raw.githubusercontent.com/BuddyChewChew/app-m3u-generator/main/playlists/plutotv_ar.m3u"
    ...
    async def get_servers(self, movie_id: str) -> list[Server]:
        return [Server(id=movie_id, name="PlutoTV Stream")]
